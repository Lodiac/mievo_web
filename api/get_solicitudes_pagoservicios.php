<?php
// get_solicitudes_pagoservicios.php - NUEVA LÓGICA SIMPLIFICADA
...
try {
    ...
    // =============================================
    // CONSULTA FINAL DE SOLICITUDES DE PAGO DE SERVICIOS
    // =============================================
    ...
    // Consulta final para pago de servicios
    ...
    while ($row = mysqli_fetch_assoc($result_solicitudes)) {
        ...
        if ($row['es_propia'] == 1) {
            $row['nombre_tienda'] = 'Tu solicitud';
        }
    ...
    echo json_encode([
        ...
        "debug_info" => [
            ...
            "role" => $role,
            "metodo" => 'NUEVA_LOGICA_SIMPLIFICADA_PAGO_SERVICIOS'
        ]
    ]);

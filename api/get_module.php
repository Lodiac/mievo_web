...
$allowedModules = [
    'root' => [ 'dashboard', 'tiendas', 'solicitudes', 'vendedores','atencion_clientes','bolsa_saldo','reportes','pagos'],
    'admin' => [ 'dashboard', 'tiendas', 'solicitudes','vendedores','portabilidad','recuperacion','pagos'],
